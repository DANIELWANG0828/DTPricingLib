    ...
    public class ForwardStartMethod
    {
            ...
            [ExcelArgument(Name = "shift in strike price", Description = "shift in strike price")] double a)
        {
            ...
            if (OutPutFlag == "p")
            {
                ...
                return_value = OPLib.ForwardStartMethod.ForwardStart(cpflg, S0, t1, t2, r, b, vol, a);
            ...
            else if (OutPutFlag == "d")
            {
                ...
                return_value = OPLib.ForwardStartMethod.Delta(cpflg, S0, t1, t2, r, b, vol, a);
            ...
            else if (OutPutFlag == "v")
            {
                ...
                return_value = OPLib.ForwardStartMethod.Vega(cpflg, S0, t1, t2, r, b, vol, a);
